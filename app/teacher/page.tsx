...
export default function TeacherPage() {
  ...
  // Données mockées pour le professeur
  const teacherModules: TeacherModule[] = [
    {
      id: "1",
    ...
    },
    {
      ...
      studentCount: 25,
      examDate: "2025-01-22",
      examRoom: "Salle TD-202"
    }
  ]

  const supervisionExams: SupervisionExam[] = [
    {
      id: 1,
    ...
    {
      id: 2,
      moduleName: "Mathématiques Discrètes",
      formation: "Licence 2 Informatique",
      date: "2025-01-17",
      startTime: "14:00",
      endTime: "16:00",
  ...
  const totalModules = teacherModules.length
  const totalStudents = teacherModules.reduce((sum, module) => sum + module.studentCount, 0)
  const totalCredits = teacherModules.reduce((sum, module) => sum + module.credits, 0)
  const upcomingExams = teacherModules.filter(m => m.examDate).length
                    ...
                    <div className="space-y-4">
                      <div>
                        <div className="flex justify-between text-sm mb-2">
                          ...
                          <span>{teacherModules.filter(m => m.semester === 1).length} modules</span>
                        </div>
                        <Progress
                          value={(teacherModules.filter(m => m.semester === 1).length / totalModules) * 100}
                          className="h-2"
                        />
                      </div>
                      <div>
                        <div className="flex justify-between text-sm mb-2">
                          ...
                          <span>{teacherModules.filter(m => m.semester === 2).length} modules</span>
                        </div>
                        <Progress
                          value={(teacherModules.filter(m => m.semester === 2).length / totalModules) * 100}
                          className="h-2"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="text-center p-4 bg-muted rounded-lg">
                        <div className="text-3xl font-bold text-primary">
                          {Math.round(totalStudents / totalModules)}
                        </div>
                    ...
                    <CardContent className="p-4">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-orange-600">
                          {supervisionExams.reduce((sum, exam) => sum + exam.studentCount, 0)}
                        </div>
                    ...
                    <CardContent className="p-4">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-green-600">
                          {Math.round(supervisionExams.reduce((sum, exam) => sum + exam.studentCount, 0) / supervisionExams.length)}
                        </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {teacherModules.slice(0, 2).map((module, index) => (
